前面学了 Buffer 的 api，并且做了 DNS 二进制协议的解析。

大家对 Buffer 能做什么以及怎么用都有一些认识了。、

这节我们继续来做 Buffer 的实战：实现 WebSocket 协议的解析。

和上节一样，具体的协议格式不用细究，简单看下就行。
...
> 代码上传了[小册仓库](https://github.com/QuarkGluonPlasma/nodejs-course-code/tree/main/my-websocket)
...
我们基于 Node.js 自己手写了一个 websocket 服务，有没有感觉对 websocket 的理解更深了呢？
