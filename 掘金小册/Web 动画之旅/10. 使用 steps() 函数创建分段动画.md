...
![iShot_2024-04-07_20.27.03.gif](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/03895a8ce93b48fdbb8b3d3db9c5e6c4~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=1524&h=262&s=885247&e=gif&f=118&b=2f4f7e)
...
回到魔兽世界这个案例来，当完整查看源图像时，没有 CSS 步进动画，图像的整个“胶片”似乎在设计 Web 动画时是一种奇怪的方法。源图像非常宽，宽到肉眼无法看清。从生产的角度来看，这张图像似乎相当令人生畏，因为替换动画帧需要确保在正确的位置和正确的间距。下图就是图像的原始形式：
