...
Astro 中使用 Tailwind CSS 也非常简单，只用安装集成即可：
...
**这篇文章一定要看看：**[**《Next.js 项目写 Tailwind CSS 基本都会遇到的两个问题》**](https://juejin.cn/post/7387611028988002314)**，内容同样适用于 Astro。**
...
Tailwind CSS 提供了 tailwindcss/nesting 插件实现这一功能，在 Astro 中，当你使用 Tailwind CSS 集成后，只用添加一个配置项即可实现嵌套语法：
