...
![页签弹窗.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b8f4f26338c441d9a66572bb342556e4~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=582&h=366&s=19082&e=png&b=fefefe)
...
![10-3适配器示意图.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7f76729b22b644acaa13d3052742585e~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=754&h=294&s=31663&e=png&b=fefefe)
...
除了适配接口中时间格式问题，还可以用来转换后端返回的数据中key的格式，比如前端期望数据key为小驼峰形式(如userName)，而后端喜欢使用下划线(user_name)，那么我们可以在增加一个key值格式适配器即可。
