...
![性能优化概览-括号图.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/eec1e834dcdf40f0a808bcc0955877da~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=1898\&h=2034\&s=352132\&e=png\&b=fffcfc)
...
*   **减少网络请求大小**
    ...
    *   **图片压缩**：不要直接使用UI设计师提供的图片，记得先压缩一下，如[TinyPNG](https://tinify.cn/)
...
当浏览器遇到<script>标签时，它通常会停止解析HTML文档并等待JavaScript代码下载和执行完成。这被称为“阻塞”。通过异步加载JavaScript，浏览器可以继续解析和渲染页面的其余部分，而不会等待JavaScript代码完成下载和执行。
...
![url-load-path.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0baabb66da7b4ba5a0f0aa4c61e5ff27~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=1616\&h=2536\&s=237465\&e=png\&b=fdfdfd)
...
![api-path.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2e8bc10b77e74791ab1315ca2c1b1690~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=1065\&h=151\&s=34201\&e=png\&b=ffffff)
...
![webpack-bundle-analyzer.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3004b17deaa04770b0f409d55c7765ea~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=1280\&h=639\&s=721750\&e=png\&b=dcd0b0)
...
![chrome-long-task.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d95894927a4a42eab5a5efa5aa801f27~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=1431\&h=535\&s=215328\&e=png\&b=2b2b2b)

## 重视监测，主动发现问题

在健壮性小节当中，我们就提到过这个观点，我们不应该被动地等着用户给我们提出问题，而是通过检测，更加全面地了解当前系统的运行状态，及时发现问题、解决问题。

![monitor.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9e5285bdbfca4cb4a3ff5907c5be7c6f~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=1384\&h=519\&s=171031\&e=png\&b=ffffff)
...
![long-task-1.gif](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0e21930373f34347a006058b610dda6a~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=747&h=336&s=52190&e=gif&f=18&b=fdfdfd)
