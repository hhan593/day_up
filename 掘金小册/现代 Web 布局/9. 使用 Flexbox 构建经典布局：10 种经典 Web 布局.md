...
如果你不希望按钮宽度占满整个卡片，还可以改变 `button` 的 `align-self` 值，比如：
...
![Frame 823.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/fdef1d1bee284f7ea4148c9f4b5088d8~tplv-k3u1fbpfcp-watermark.image?)
