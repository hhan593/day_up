...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3261990529c14df099a7db47e608786f~tplv-k3u1fbpfcp-watermark.image?)
...
| 标题 |  | |
| --- | --- |--- |
| ![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/efc31faa8e2e430f966d679be3e28f9a~tplv-k3u1fbpfcp-watermark.image?) | ![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/843e46a5d3c547079eff25a2899815ed~tplv-k3u1fbpfcp-watermark.image?) |![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/dccfff02d489425b952ed31c771f3575~tplv-k3u1fbpfcp-watermark.image?)|
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/873eff43d2f548b19c6a70f758463ec7~tplv-k3u1fbpfcp-watermark.image?)
...
- 2. 将状态类通过 `with` 关键字混入 `SingleTickerProviderStateMixin`, 让状态类拥有创建 Ticker 的能力。这样在 `AnimationController` 构造方法中 `vsync` 入参就可以传入当前状态类。  
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8c69b1a0ed184f7da47461fac8b853cd~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/310bad328b4a40c3b7a753830c24513d~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/108f4bf3bab747e785d1b17c56534d57~tplv-k3u1fbpfcp-watermark.image?)
