...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b6c48111cfa6471fb1e471a6a66e1292~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/56b010d748c54892ac127e64c8ee70be~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/afeda92996ca4f4aa8ffa783a16c6a83~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f1ae29e8af2b4e76b4289ad01d32fc2a~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/eb87ab794f3a4115a5dfbed1e018bd56~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e71ed5d4f9824af0aecc1427edfec5b7~tplv-k3u1fbpfcp-watermark.image?)

如果希望对象可以赋值为 null ，需要在类型后加上 `?` 表示可空：

![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9297c83e2375496589f5cee607521838~tplv-k3u1fbpfcp-watermark.image?)

这样，如果一个函数中是 String 入参，那么函数体内的 word 对象就必定不为 null ，这样就可以在编码时明确对象的可空性，做到被访问对象的空安全。

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1f7919d818cb45d2a2d7770a2d0c28b8~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5a2b4464dcd947c18e8e88d6fcdbb944~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ae62843cb5d24d01a8dfc19aaaf333be~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7135f8b1ff514d6d9f8888d4dbefc441~tplv-k3u1fbpfcp-watermark.image?)
