...
项目源码在 github 上托管，项目名是 : **[flutter_first_station](https://github.com/toly1994328/flutter_first_station)** ，寓意是 Flutter 的第一站。

![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/41aa865615214005ab494529ff423b3e~tplv-k3u1fbpfcp-watermark.image?)

另外，源码是最终版效果，中间一步步的实现过程通过提交节点来查看，在文章相关位置会有对应节点的连接地址，访问即可看到当前步骤下的源码。

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e1d6bd9e31a441baa11876a045ce3ed5~tplv-k3u1fbpfcp-watermark.image?)

比如上面是 13 章介绍电子木鱼静态界面构建的章节，点击就会进入当前节点所处的源码位置：

![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/97117b9c17344d208fe07f0c93c26cbf~tplv-k3u1fbpfcp-watermark.image?)
