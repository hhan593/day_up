...
| 界面显示部件 | 修改展示信息 |
| --- | --- |
| ![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b0c5ec5bb356406aacb9717dad1c02de~tplv-k3u1fbpfcp-watermark.image?) | ![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d37c071988b54870900f0848ffb04e72~tplv-k3u1fbpfcp-watermark.image?) |
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7896736a24b94326955410e50fc967bf~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0b418d8159814cffab9ba363ac9f47c8~tplv-k3u1fbpfcp-watermark.image?)

在点击之后，就可以跳转到对应的位置，此时光标会在那里闪烁，如下所示：

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/90be9e5f947e4b6c865634e2b6126df0~tplv-k3u1fbpfcp-watermark.image?)

当鼠标 `悬浮` 在上方的文件名上时, 会弹出文件所在的磁盘地址，这样能便于我们找到文件所在：

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b11d9fabacd541e0bd57e3c9c22ff6e5~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c137dd68582e48b5a93a8addd180ceb3~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/530c0c441e8b44ebad9052147a2c5172~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/82fd3a41fd8a465b8ebb93ddefdb948d~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/572b6d1b63224047917d393db445d2a9~tplv-k3u1fbpfcp-watermark.image?)

选择模式下，当点击界面上的显示部件，就会自动挑战到对应的代码位置。对于定位代码来说，可谓神器。另外注意一点，点击后左下角会有个搜索按钮，如果想选择其他部件，要先点一下那个搜索按钮：

| 选择模式 | 选择模式 |
| --- | --- |
| ![6d3f2cb9b7ae239d7f3df42465bbfba.jpg](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8a29f49df0664aa3a7e9bd8e78291202~tplv-k3u1fbpfcp-watermark.image?) | ![99341641f41be18287b3ce83946f002.jpg](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f212dd07e858451bbfade80f8bffd919~tplv-k3u1fbpfcp-watermark.image?) |
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7f1da21d74484c9fa43a6aa4bbb74374~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/46562f81124a470485f4809a1d5be38f~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/38c0175e4b714416bf3e229c1dbaf75a~tplv-k3u1fbpfcp-watermark.image?)

这样，在 `Ctrl+S` 保存之后，界面就会立刻更新：

![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9db16e410afc43d9907b633f7a81e78b~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/23f118060cfc4233944de69d5bec7acd~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/69dbc09d0e9441b9a90828602f026564~tplv-k3u1fbpfcp-watermark.image?)
...
| 无辅助 | 有辅助 |
| --- | --- |
| ![5b24fc4e6fac1af34f4bda584ad81c8.jpg](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0ade4801fb79472f8d428b99eb7c4f80~tplv-k3u1fbpfcp-watermark.image?) | ![3f33fe6b358616691bed87f780f856c.jpg](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bb726b677a4547c282f25674b30bd614~tplv-k3u1fbpfcp-watermark.image?) |

---

如下，通过选择模式，可以很轻松地知道，中间的区域是 `Column` 的地盘。代码中的表现是 `Column` 在构造时将两个文字作为孩子； `Column` 单词的含义是 `列` ，它的作用是将若干个子组件竖直排列。

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6acd3c4d8d814c438359286ae3e75f4f~tplv-k3u1fbpfcp-watermark.image?)
...
| --- | --- |
| ![9430243f800f50e115faeb681954316.jpg](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ad4e412c92414dd5ae5cca0f169c2bde~tplv-k3u1fbpfcp-watermark.image?) | ![5eb3f6d4210841d4fddc8fb7a3bf97f.jpg](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c3b4c43ce33645fa9e9cac129489be3d~tplv-k3u1fbpfcp-watermark.image?) |

---

之前说过，在选择模式下，点击树中条目，对选中对于的位置。比如下面点击 `Center`，就可以看到它的地盘，它的作用是让它地盘中的子组件居中对其；这也是 `Column` 能在中间的根本原因：

![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6505ffd9fa184c418db7cc3dc0f4d392~tplv-k3u1fbpfcp-watermark.image?)
