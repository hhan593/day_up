...
| - | - |
| --- | --- |
| ![113.gif](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/56f1d6ccfae140a6b03428dec3fff484~tplv-k3u1fbpfcp-watermark.image?) | ![114.gif](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7661c5e8989c4a5496ccbba629c830a3~tplv-k3u1fbpfcp-watermark.image?) |
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/876ce00bc7ad495f92c324f90d68ae7e~tplv-k3u1fbpfcp-watermark.image?)
...
| 在绘制面板绘制 | 切换后，状态重置  |
| --- | --- |
| ![115.gif](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8806075b80914a2ba2a504a84df0db6c~tplv-k3u1fbpfcp-watermark.image?) | ![116.gif](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2a5467e8cb7c46f1862c40e7e1ecc645~tplv-k3u1fbpfcp-watermark.image?) |
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7786b5db358a42e1b6b63704d17ed2fd~tplv-k3u1fbpfcp-watermark.image?)



| 在绘制面板绘制 | 切换后，状态保活 |
| --- | --- |
| ![117.gif](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ec2e104d3a0e4d0a8724dfd84545b9ca~tplv-k3u1fbpfcp-watermark.image?) | ![118.gif](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/323b575bbc5949e28e77c601604c183e~tplv-k3u1fbpfcp-watermark.image?) |
...
| --- | --- |
| ![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f1e25ee0264f4a94917679690a479e15~tplv-k3u1fbpfcp-watermark.image?) | ![42f13c95e59f1a9129353d2b3f22e37.jpg](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/dce8f397018c43b1ac16c4dcfcb40a49~tplv-k3u1fbpfcp-watermark.image?) |
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/defd4c963bbb40c1841f6f3ffe10ba03~tplv-k3u1fbpfcp-watermark.image?)

如果每次使用 AppBar 组件就配置一次，那代码书写将会非常复杂。Flutter 在主题数据的功能，只要指定主题，其下节点中的对应组件，就会默认使用的配置数据。如下所示，在 MaterialApp 的 theme 入参中可以配置主题数据：

![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f81c9b3b2ca34f69a41e299c059b5eb1~tplv-k3u1fbpfcp-watermark.image?)

这样，以前使用 AppBar 的地方就不用再配置那么多信息了。比如电子木鱼界面的 AppBar 就可以清爽多了：

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9fe609824594409482599eb10d5a5d39~tplv-k3u1fbpfcp-watermark.image?)
