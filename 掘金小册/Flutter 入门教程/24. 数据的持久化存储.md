...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/644e078ed1a6451694b7e1033c3b3752~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0e58ec01a8264cdfbbff89e967e85cf0~tplv-k3u1fbpfcp-watermark.image?)
...
目前来说，最完善的 sqlite 数据库插件是 [sqlite](https://pub.flutter-io.cn/packages/sqflite) ,
使用前首先需要添加依赖：
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9837220755b54a4e92f76ec15690bb34~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8589f031719d4a75a94b2fad7fc03d1c~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/26a2fddfdece46a7b88da25f82cdd29d~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/468fd9890a4c44e7ad074e89f8eb02cb~tplv-k3u1fbpfcp-watermark.image?)

- 在 `_MuyuPageState` 中状态初始化时读取数据。

![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4bd86f6628404914b6b29dcbdd099b40~tplv-k3u1fbpfcp-watermark.image?)

然后点击木鱼后就可以看到数据表中会存储对于的数据，应用退出之后也能从数据库中加载数据。

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4feea28eb9f843aaa7850ac3da3a5b58~tplv-k3u1fbpfcp-watermark.image?)
