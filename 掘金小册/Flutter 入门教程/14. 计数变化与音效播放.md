...
| - | - |
| --- | --- |
| ![97.gif](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5fbc04c4f0824397a93d2f524721581a~tplv-k3u1fbpfcp-watermark.image?) |![98.gif](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ec6ba67422b94668bfb19d1ac26ab19d~tplv-k3u1fbpfcp-watermark.image?)  |
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1b022067005044b19fe3985f7c82f76e~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/902a3b4c52b343a58a61d6154a5c9cdb~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/dc10805ad66f4647809b8c1678e27586~tplv-k3u1fbpfcp-watermark.image?)

---

如下所示，加入依赖后，点击 pub get 获取依赖包：

![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/585b129a181f4d8e9de506dd6cdd36fe~tplv-k3u1fbpfcp-watermark.image?)

---

现在要播放音效，首先需要相关的音频资源，而使用本地资源，需要在 `pubspec.yaml` 中进行配置：这里准备了三个木鱼点击的音效，放在 `audio` 文件夹中。

![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b5ce09b80f944ce99b6e0f824cafe1d6~tplv-k3u1fbpfcp-watermark.image?)
...
| - | - |
| --- | --- |
| ![99.gif](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c29ef685cc03488b89cfa30b12f11766~tplv-k3u1fbpfcp-watermark.image?) | ![100.gif](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/fd41acc182954c6ca1a67020d7bf89b0~tplv-k3u1fbpfcp-watermark.image?) |
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7d790339a0914d9f96082e512326799a~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e8b2ce6d29bc4e90aa2265d6420a4a18~tplv-k3u1fbpfcp-watermark.image?)
...
| - | - |
| --- | --- |
| ![101.gif](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5a4e1d55c647446d942a1428904dc1a9~tplv-k3u1fbpfcp-watermark.image?) | ![102.gif](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6f5b5458079c4d06b60b46172d5834bc~tplv-k3u1fbpfcp-watermark.image?) |
