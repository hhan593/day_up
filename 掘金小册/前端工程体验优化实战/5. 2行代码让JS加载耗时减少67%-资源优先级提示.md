...
例如，我们网站的有部分懒加载的静态资源，部署在域名为 [static.juejin.com](static.juniortour.com) 的CDN上，那么在HTML中添加如下2行HTML代码：
``` html
