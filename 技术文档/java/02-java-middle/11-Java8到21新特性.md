...
- **Lambda 表达式 + 函数式接口**（JSR 335）→ `07-Lambda与函数式编程.md`
- **Stream API** → `07-Lambda与函数式编程.md`
- **Optional** → `07-Lambda与函数式编程.md`
- **接口默认方法 / 静态方法** → `03-面向对象类与对象.md`
...
- **密封类 Sealed Classes**（JEP 409）正式 → `09-密封类与模式匹配.md`
- **模式匹配 instanceof**（JEP 394）正式 → `09-密封类与模式匹配.md`
- **文本块 Text Blocks**（JEP 378）正式 → `02-Java语言基础.md`
...
- **虚拟线程 Virtual Threads**（JEP 444）正式 GA → `10-虚拟线程.md`
- **模式匹配 switch**（JEP 441）正式 → `09-密封类与模式匹配.md`
