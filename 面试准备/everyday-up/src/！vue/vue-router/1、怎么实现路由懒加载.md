...
这是一道应用题。当打包应用时，JavaScript 包会变得非常大，影响把页面加载。如果我们能不同路由对应的组件分割成不同的代码块，然后当路由被访问时才加载对应组件，这样就会更加高效。
...
- 结合注释() => import(/_ webpackChunkName: "group-user" _/ './UserDetails.vue')可以做 webpack 代码分块
