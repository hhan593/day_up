### 25、封装一个 storage、基于localStorage 可以实现过期时间？
[得出 localstorage 还有多少空间可用](https://mp.weixin.qq.com/s/dwW8IPsA1DR4XE-InmKGmw)
[实现 localstorage 的高级用法 --- 过期、加密](https://mp.weixin.qq.com/s/dwW8IPsA1DR4XE-InmKGmw)
...
<!-- 简单封装，都设置在 localstorage 的 manager 下 -->
```js
const config = {
  namespace: 'manager'
}
